	...
	<view>
		...
		<view class="footer">
			...
			<view class="btn">
				...
				<view class="buy" @tap="buy">立即联系</view>
			</view>
		</view>
		<!-- share弹窗 -->
		...
		<view class="swiper-box">
			<swiper circular="true" autoplay="true" @change="swiperChange">
				<swiper-item v-for="swiper in swiperList" :key="swiper.id"><image :src="swiperTemp512" @tap="toSwiper(swiper)"></image></swiper-item>
			</swiper>
			<!-- <swiper circular="true" autoplay="true" @change="swiperChange">
	...
	onLoad(option) {
		uni.request({
			...
			success: res => {
				...
				this.goodsData = data;
				this.swiperTemp512 = data.cover;
				this.descriptionStr = data.content;
			}
		});
		// #ifdef MP
		//小程序隐藏返回按钮
