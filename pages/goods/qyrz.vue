		...
		<view class="goods-list" v-show="goodsList.length > 0">
			<view class="product-list">
				...
				<view class="product" v-for="goods in goodsList" :key="goods.houseId">
					...
					<view class="info">
						<view class="price">{{ goods.name }}</view>
					</view>
					<view class="info">
						<view class="slogan">位置：{{ goods.location }}</view>
					</view>
					<!-- <view class="name">入驻时间：{{ goods.beginDate.substring(0, 10) }}，入驻时长：{{ goods.duration }}月</view> -->
				</view>
			</view>
